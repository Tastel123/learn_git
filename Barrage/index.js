let data = [
    ...
    {value: '0000000000w    erwef', time: 3, color: '#00a1f5', speed: 2, fontSize: 20},

    {value: 'fpeiojgpiqerjdkm', time: 10, color: 'pink', speed: 1.5, fontSize: 18},
]
...
let $txt = doc.getElementById('txet')
